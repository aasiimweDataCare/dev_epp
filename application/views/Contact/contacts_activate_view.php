...
<div id="page-wrapper">
    <fieldset class="fieldset-border">
        <legend class="fieldset-border">
            ...
            Activate Contact&nbsp;&nbsp;<i class="fa fa-binoculars fa-2x fa-rotate-270" aria-hidden="true"></i>
        </legend>
        <div class="row">
            <h3>Activate Contact:</h3>
            <?php $attributes = array("class" => "form-horizontal", "id" => "activateContact-form", "name" => "activateContact-form");
            echo form_open("RegisteractivateContactsController/index", $attributes);
            ?>
                ...
                <div class="input-group col-sm-6">
                    ...
                    <span class="input-group-btn">
                        <button
                                ...
                                type="submit"
                                name="activateContact-button"
                                value="submitSearchQuery"
                                id="activateContact-button">
