...
<div id="page-wrapper">
    <fieldset class="fieldset-border">
        <legend class="fieldset-border">
            ...
            Search Contact&nbsp;&nbsp;<i class="fa fa-binoculars fa-2x fa-rotate-270" aria-hidden="true"></i>
        </legend>
        <div class="row">
            <h3>Search Contact:</h3>
            <?php $attributes = array("class" => "form-horizontal", "id" => "searchContact-form", "name" => "searchContact-form");
            echo form_open("RegistersearchContactsController/index", $attributes);
            ?>
                ...
                <div class="input-group col-sm-6">
                    ...
                    <span class="input-group-btn">
                        <button
                                ...
                                type="submit"
                                name="searchContact-button"
                                value="submitSearchQuery"
                                id="searchContact-button">
