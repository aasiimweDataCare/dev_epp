...
<div id="page-wrapper">
    <fieldset class="fieldset-border">
        <legend class="fieldset-border">
            ...
            Deactivate Contact&nbsp;&nbsp;<i class="fa fa-binoculars fa-2x fa-rotate-270" aria-hidden="true"></i>
        </legend>
        <div class="row">
            <h3>Deactivate Contact:</h3>
            <?php $attributes = array("class" => "form-horizontal", "id" => "deactivateContact-form", "name" => "deactivateContact-form");
            echo form_open("RegisterdeactivateContactsController/index", $attributes);
            ?>
                ...
                <div class="input-group col-sm-6">
                    ...
                    <span class="input-group-btn">
                        <button
                                ...
                                type="submit"
                                name="deactivateContact-button"
                                value="submitSearchQuery"
                                id="deactivateContact-button">
